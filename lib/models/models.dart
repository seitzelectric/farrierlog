  ...
  factory HorseWithClientInfo.fromMap(Map<String, dynamic> map) {
    return HorseWithClientInfo(
      ...
      client: Client.fromMap({
        ...
        'internal_notes': map['client_internal_notes'],
  ...
  Visit copyWith({
    ...
    bool? isAutoGenerated,
      ...
      Visit(
        ...
        recurrenceWeeks: recurrenceWeeks ?? this.recurrenceWeeks,
        nextRecurringVisitId: nextRecurringVisitId ?? this.nextRecurringVisitId,
